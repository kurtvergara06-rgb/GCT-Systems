...
>
            ...
            <section class="table-card jo-table-card">
                ...
                <div class="section-header">
                    ...
                    <div>
                        ...
                        <p>
                            Track job order details, assigned mechanics,
                            completion status, and parts progress
                        </p>
                ...
                >
                    ...
                    <div class="filter-group">
                        ...
                        >
                            ...
                            <option
                                value="All Part Statuses"
                                {{ request('part_status', 'All Part Statuses') === 'All Part Statuses' ? 'selected' : '' }}
                            >
                                All Part Statuses
                            </option>
                            ...
                            <option
                                value="Not Requested"
                                {{ request('part_status') === 'Not Requested' ? 'selected' : '' }}
                            >
                                Not Requested
                            </option>
                            ...
                            <option
                                value="Submitted"
                                {{ request('part_status') === 'Submitted' ? 'selected' : '' }}
                            >
                                Submitted
                            </option>
                            ...
                            <option
                                value="Approved"
                                {{ request('part_status') === 'Approved' ? 'selected' : '' }}
                            >
                                Approved
                            </option>
                            ...
                            <option
                                value="Rejected"
                                {{ request('part_status') === 'Rejected' ? 'selected' : '' }}
                            >
                                Rejected
                            </option>
                            ...
                            <option
                                value="For Purchase"
                                {{ request('part_status') === 'For Purchase' ? 'selected' : '' }}
                            >
                                For Purchase
                            </option>
                            ...
                            <option
                                value="Ordered"
                                {{ request('part_status') === 'Ordered' ? 'selected' : '' }}
                            >
                                Ordered
                            </option>
                            ...
                            <option
                                value="For Pick-up"
                                {{ request('part_status') === 'For Pick-up' ? 'selected' : '' }}
                            >
                                For Pick-up
                            </option>
                            ...
                            <option
                                value="For Delivery"
                                {{ request('part_status') === 'For Delivery' ? 'selected' : '' }}
                            >
                                For Delivery
                            </option>
                            ...
                            <option
                                value="Delivered"
                                {{ request('part_status') === 'Delivered' ? 'selected' : '' }}
                            >
                                Delivered
                            </option>
                            ...
                            <option
                                value="Picked Up"
                                {{ request('part_status') === 'Picked Up' ? 'selected' : '' }}
                            >
                                Picked Up
                            </option>
                            ...
                            <option
                                value="Issued"
                                {{ request('part_status') === 'Issued' ? 'selected' : '' }}
                            >
                                Issued
                            </option>

                            <option
                                value="No Parts Needed"
                                {{ request('part_status') === 'No Parts Needed' ? 'selected' : '' }}
                            >
                                No Parts Needed
                            </option>
                    ...
                    <div class="filter-group">
                        ...
                        >
                            ...
                            <option
                                value="All Types"
                                {{ request('maintenance_type', 'All Types') === 'All Types' ? 'selected' : '' }}
                            >
                                All Types
                            </option>
                            ...
                            <option
                                value="PMS"
                                {{ request('maintenance_type') === 'PMS' ? 'selected' : '' }}
                            >
                                PMS
                            </option>
                            ...
                            <option
                                value="Repair"
                                {{ request('maintenance_type') === 'Repair' ? 'selected' : '' }}
                            >
                                Repair
                            </option>
                            ...
                            @forelse($jobOrders as $jobOrder)
                                ...
                                @php
                                    ...
                                    */
                                    ...
                                    $linkedPr =
                                        \App\Models\Maintenance\PurchaseRequest::query()
                                            ->where(
                                                'job_order_no',
                                    ...
                                    <td>
                                        ...
                                        <div class="actions">
                                            ...
                                            <x-ui.action-buttom-modal
                                                ...
                                                data-assigned-mechanic="{{
                                                    $jobOrder->assigned_mechanic
                                                }}"

                                                data-part-needed="{{
                                                    $jobOrder->part_needed
                                                }}"
                                            ...
                                            @if($canCreatePr)
                                                ...
                                                <form
                                                    ...
                                                    data-confirm-message="
                                                        Are you sure you want to create a Purchase Request from job order {{ $jobOrder->job_order_no }}?
                                                    "
                                            ...
                                            @if($isRejectedPr)
                                                ...
                                                <a
                                                    ...
                                                    title="
                                                        Revise Rejected Purchase Request
                                                    "
                                                >
                                            ...
                                            >
                                                ...
                                                @if($hasLinkedPr)
                                                    ...
                                                    <button
                                                        ...
                                                        title="
                                                            Cannot delete: this Job Order already has a linked Purchase Request.
                                                        "
    ...
    >
        ...
        <div
            ...
            class="jo-parts-section is-locked"
        >
            ...
            >
                ...
                >
                    ...
                    <div>
                        ...
                        <span>
                            Requested parts can be added after a mechanic
                            is assigned to inspect the bus.
                        </span>
            ...
            >
                ...
                >
                    ...
                    <div>
                        ...
                        <span>
                            Requested parts can only be entered after
                            a mechanic is assigned to inspect the bus.
                        </span>
                ...
                function () {
                    ...
                    const busSelect =
                        document.querySelector(
                            '#jobModal select[name="bus_no"]'
                        );


                    const issueField =
                        document.querySelector(
                            '#jobModal textarea[name="problem_issue"]'
                        );


                    const typeSelect =
                        document.querySelector(
                            '#jobModal select[name="maintenance_type"]'
                        );

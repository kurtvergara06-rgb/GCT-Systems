        ...
        <main class="main activity-logs-page">
            ...
            <section class="stats-grid activity-stats-grid">
                ...
                <x-ui.summary-card
                    label="User Actions"
                    value="31"
                    small="Account-based activities"
                    icon="fa-user-check"
                    color="green"
                />
                ...
                <x-ui.summary-card
                    label="System Events"
                    value="8"
                    small="Automated system activities"
                    icon="fa-gears"
                    color="yellow"
                />
            ...
            @php
                $logs = [
                    [
                        ...
                        'date' => 'Jul 25, 2026',
                        'time' => '9:42 PM',
                        'details' => 'Changed the account status of Juan Santos from Pending to Active.',
                        'ip' => '192.168.1.12',
                    ...
                    [
                        ...
                        'user' => 'Marco Salazar',
                        'role' => 'Operation Head',
                        'activity' => 'Updated shuttle bus record',
                        'module' => 'Operation',
                        'reference' => 'BUS-012',
                        'type' => 'Updated',
                        'date' => 'Jul 25, 2026',
                        'time' => '8:15 PM',
                        'details' => 'Changed the operational status of BUS-012 to Under Maintenance.',
                        'ip' => '192.168.1.25',
                        'device' => 'Chrome / Windows 11',
                    ],
                    [
                        'initials' => 'JM',
                        'user' => 'Juan Miguel Santos',
                        'role' => 'Maintenance Head',
                        'activity' => 'Approved purchase request',
                        'module' => 'Maintenance',
                        'reference' => 'PR-2026-0021',
                        'type' => 'Approval',
                        'date' => 'Jul 25, 2026',
                        'time' => '6:30 PM',
                        'details' => 'Approved the maintenance purchase request for requested replacement parts.',
                        'ip' => '192.168.1.31',
                    ...
                    [
                        ...
                        'activity' => 'Updated inventory item',
                        'module' => 'Warehouse',
                        'reference' => 'PART-0045',
                        'type' => 'Updated',
                        'date' => 'Jul 25, 2026',
                        'time' => '3:18 PM',
                        'details' => 'Updated the stock quantity of Engine Oil Filter in warehouse inventory.',
                        'ip' => '192.168.1.41',
                        'device' => 'Chrome / Windows 11',
                    ],
                    [
                        ...
                        'user' => 'Rafael Perez',
                        'role' => 'Purchase Staff',
                        'activity' => 'Created purchase order',
                        'module' => 'Purchase',
                        'reference' => 'PO-2026-0015',
                        'type' => 'Created',
                        'date' => 'Jul 25, 2026',
                        'time' => '1:06 PM',
                        'details' => 'Created a purchase order from an approved maintenance purchase request.',
                        'ip' => '192.168.1.52',
                    ...
                    [
                        ...
                        'activity' => 'User login',
                        'module' => 'Admin',
                        'reference' => 'LOGIN-0725-01',
                        'type' => 'Login',
                        'date' => 'Jul 25, 2026',
                        'time' => '8:02 AM',
                        'details' => 'Successful administrator login to FROMS.',
                        'ip' => '192.168.1.12',
                        'device' => 'Chrome / Windows 11',
                    ],
                ];
            ...
            <section class="table-card activity-table-card">
                ...
                <div class="section-header">
                    ...
                    <div>
                        ...
                        <p>
                            Review important user actions and system events recorded across FROMS.
                        </p>
                    </div>
                ...
                <div class="activity-toolbar">
                    ...
                    <div class="search-box">
                        ...
                        <input
                            type="text"
                            placeholder="Search user, activity, reference..."
                        >
                    </div>
                ...
                <div class="table-footer">
                    ...
                    <p>
                        Showing 1 to 6 of 42 activities
                    </p>
            ...
            <div class="activity-modal-header">
                ...
                <div class="modal-heading">
                    ...
                    <div>
                        ...
                        <p>
                            Complete information about the selected system activity.
                        </p>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function openModal(button) {
                ...
                document.getElementById('modalModule').textContent =
                ...
                document.getElementById('modalIp').textContent =
                    button.dataset.ip || '—';

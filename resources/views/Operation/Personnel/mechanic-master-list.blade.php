            ...
            <section class="personnel-master-panel">
                <div class="personnel-master-header">
                    <div>
                        ...
                        <p>Permanent records used by job orders and daily attendance.</p>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('operation.personnel.mechanics.store', [], false) }}" class="personnel-master-form">
                    ...
                    <label>Shift<select name="shift"><option>Morning</option><option>Afternoon</option><option>Night</option></select></label>

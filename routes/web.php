...
Route::controller(JobOrderController::class)->group(function () {
    Route::get('/job-orders', 'index')->name('job-orders');
    Route::post('/job-orders', 'store')->name('job-orders.store');
    Route::put('/job-orders/{jobOrder}', 'update')->name('job-orders.update');
    Route::delete('/job-orders/{jobOrder}', 'destroy')->name('job-orders.destroy');
});
...
Route::controller(PurchaseRequestController::class)->group(function () {
    ...
    Route::post('/purchase-requests', 'store')->name('purchase-requests.store');
    Route::put('/purchase-requests/{purchaseRequest}', 'update')->name('purchase-requests.update');
    Route::delete('/purchase-requests/{purchaseRequest}', 'destroy')->name('purchase-requests.destroy');

    Route::post('/purchase-requests/{purchaseRequest}/approve', 'approve')->name('purchase-requests.approve');
    Route::post('/purchase-requests/{purchaseRequest}/reject', 'reject')->name('purchase-requests.reject');
    Route::post('/purchase-requests/{purchaseRequest}/for-purchase', 'markForPurchase')->name('purchase-requests.for-purchase');
    Route::post('/purchase-requests/{purchaseRequest}/pending-purchase', 'markPendingPurchase')->name('purchase-requests.pending-purchase');
    Route::post('/purchase-requests/{purchaseRequest}/delivering', 'markDelivering')->name('purchase-requests.delivering');
    Route::post('/purchase-requests/{purchaseRequest}/delivered', 'markDelivered')->name('purchase-requests.delivered');
    Route::post('/purchase-requests/{purchaseRequest}/issue', 'issue')->name('purchase-requests.issue');
});
...
Route::controller(InventoryController::class)->group(function () {
    ...
    Route::put('/inventory/{inventoryItem}', 'update')->name('inventory.update');
    Route::delete('/inventory/{inventoryItem}', 'destroy')->name('inventory.destroy');
...
Route::view('/driver-attendance', 'Operation.driver-attendance')->name('driver-attendance');
Route::view('/mechanic-attendance', 'Operation.mechanic-attendance')->name('mechanic-attendance');

...
Route::get('/descriptive',[DescriptiveAnalyticsController::class,'index'])->name('analytics.descriptive');
...
Route::get('/{stage}',[AnalyticsStageController::class,'show'])->whereIn('stage',['diagnostic','predictive','prescriptive'])->name('analytics.stage');
});